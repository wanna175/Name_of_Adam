...
public class UI_ProgressSummary : UI_Scene
{
    ...
    public void SetProgressText()
    {
        ...
        SetProgressText(_progress.PhanuelFall, 500, $"{GameManager.Locale.GetLocalizedBattleScene("Phanuel corrupted")}", ProgressList[10]); //
        SetProgressText(_progress.HorusFall, 500, $"{GameManager.Locale.GetLocalizedBattleScene("Savior corrupted")}", ProgressList[11]); //
