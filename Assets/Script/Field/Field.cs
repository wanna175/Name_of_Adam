...
public class Field : MonoBehaviour
{
    ...
    // 필드의 생성을 위한 필드의 위치
    private Vector3 FieldPosition => new Vector3(0, -1.15f, 2.5f);
    private Vector3 FieldRotation => new Vector3(26f, 0, 0);
    private Vector3 FieldScale => new Vector3(22f, 10f, 1f);
